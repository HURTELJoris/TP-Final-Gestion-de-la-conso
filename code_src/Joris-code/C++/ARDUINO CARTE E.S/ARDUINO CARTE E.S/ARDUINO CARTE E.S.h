...
#ifndef ARDUINO_CARTE_ES_H
#define ARDUINO_CARTE_ES_H
...
class ArduinoCarteES {
public:
    // Constructeur de la classe ArduinoCarteES
    // @param serverAddress : adresse IP du serveur Node.js
    // @param serverPort : port d'écoute du serveur Node.js
    ArduinoCarteES(const std::string& serverAddress, int serverPort, const std::string& serialPort);
